    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        try{
            ...
            while (cursor.hasNext()) {
                ...
                if (userRole.equals("Pharmacy Manager")) {
                    // Replace the code to open AdminDashboard here
                    this.dispose();
                    new AdminDashboard(username).setVisible(true);
                } else {
                    // Replace the code to open SalesPerson here
                    this.dispose();
...
// Checking if the user was not found
            if (!userFound) {
